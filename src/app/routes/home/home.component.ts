    ...
    this.agents = [
      {
        ...
        "user_id": 1,
        "last_fetched_at": {
          "Time": new Date(Date.parse("2024-10-31T16:11:44.119303Z")),
          "Valid": true,
        },
      ...
      },
      {
        ...
        "thumbnail_url":
          "https://img.kleinanzeigen.de/api/v1/prod-ads/images/f1/f1d09f04-cafc-43dc-9430-01dff1b850eb?rule=$_0.JPG",
      },
      {
        "id": 3,
        "name": "Monitor Trier",
